...
function AnswerQuestion({token}) {
  ...
  const fetchQuestions = async () => {
      const res = await axios.get('https://microservices-questions.herokuapp.com/questions');
  ...
  function postAnswerQuestion() { // Backend call for posting an answer
    axios
      .post(`https://microservices-answers.herokuapp.com/questions/${selectedQuestionId}/answers`, {
        answerContent: body
      },
  ...
  const fetchAnswers = async (questionId) => {
    const res = await axios.get(`https://microservices-answers.herokuapp.com/questions/${questionId}/answers`);
