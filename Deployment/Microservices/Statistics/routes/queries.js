...
// mysql://b1d233962f726c:0c5a0573@eu-cdbr-west-01.cleardb.com/heroku_55708fb77cc5d1b?reconnect=true
const pool  = mysql.createPool({
  ...
  user            : 'b1d233962f726c',
  password        : '0c5a0573',
  database        : 'heroku_55708fb77cc5d1b',
  dateStrings     : true
});
    ...
    try{
        ...
        if(res[0]){
            ...
            req_obj = {
                ...
                requester: 'https://microservices-statistics.herokuapp.com/'  // Stating identity of service
            }
            // console.log(req_obj);
        }
        else{
            req_obj = {
                ...
                requester: 'https://microservices-statistics.herokuapp.com/'
            }
        }
