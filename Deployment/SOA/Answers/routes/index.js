...
const ValidateQuestion = async (questionId) => {
    ...
    if (quest_offered) {
        const validationRes = await axios.post('https://soa-esb.herokuapp.com/serviceExecution', reqBody);
...
router.get('/questions/:id/answers', async function (req, res) {
    ...
    const {data:answers}= await axios.post(`https://soa-data-layer.herokuapp.com/getAnswers`, {question_id:questionId});
    console.log(answers);
...
router.post('/questions/:id/answers', 
    async function (req, res){
        ...
        const {insertId} = await axios.post(`https://soa-data-layer.herokuapp.com/createAnswer`,
...
router.delete('/questions/:questionId/answers/:answerId', 
    async function(req, res){
        ...
        const {data:deleteRes}= await axios.post(`https://soa-data-layer.herokuapp.com/deleteAnswer`, {question_id:questionId,answer_id:answerId});
...
router.get('/myAnswers',
  async function(req, res) {
    ...
    const {data:myAnswers}= await axios.post(`https://soa-data-layer.herokuapp.com/getMyAnswers`, {user});
    res.send(myAnswers);
});
