...
router.post('/signin',
    ...
    try{
        const {data:result}= await axios.post(`https://soa-users-data-layer.herokuapp.com/signIn`, {username:req.body.username, password:req.body.password});
        console.log(result);
...
router.post('/signup',
    ...
    try{
        ...
        const {data:result}= await axios.post(`https://soa-users-data-layer.herokuapp.com/signUp`, {username:username, password:hashed_password});
        console.log(result);
